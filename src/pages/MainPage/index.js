...
export function MainPage() {
  ...
  return (
    <main className="main-page">
      <Header title="momoTalk" onHelpClick={() => void open('https://twitter.com/messages/compose?recipient_id=1390445620444291073&ref_src=twsrc%5Etfw')}/>
      <Sidebar>
      ...
      <ChatPage key={currentLanguage} candidates={selectedCharacters}/>
    </main>
  );
}
